...
if __name__ == "__main__":
    MyLibrary = library(["A Tale of Two Cities", "The Little Prince", "Harry Potter and the Philosopher's Stone", "And Then There Were None", "Dream of the Red Chamber", "The Hobbit"])
    student = students(["Aniket"])
    extras = extra([""])
        ...
        if a == 1:
            while (True):
                ...
                if b == 1 :
                    ...
                    MyLibrary.borrowBook(student.requestBook())
            ...
            while (True):
                ...
                if c == 1 :
                    ...
                    student.newStudent(student.displayAvaliableStudents())
                
                elif c == 3 :
                    extra.addNewStudent(student.newStudent())
                
                elif c == 4 :
                    extra.removeStudent(student.removestudent())
